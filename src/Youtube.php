...
class Youtube
{
    ...
    public static function postVideo($videoPath, $meta = [])
    {
        $options = [
            'title'       => $videoPath,
            'description' => '',
        ...
        $client->refreshToken(config('youtube.REFRESH_TOKEN'));
...
// Define an object that will be used to make all API requests.
        ...
        try {
            ...
            $snippet->setTitle($options['title']);
     ...
     * @throws \Exception
     */
    public function getActivitiesByChannelId(
        $channelId,
